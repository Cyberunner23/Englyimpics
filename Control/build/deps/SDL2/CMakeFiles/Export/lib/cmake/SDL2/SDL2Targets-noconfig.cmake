...
set_target_properties(SDL2::SDL2-static PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "m;dl;/usr/lib/libsndio.so;dbus-1;ibus-1.0;gio-2.0;gobject-2.0;glib-2.0;unwind;unwind-generic;ts;-Wl,--no-undefined;-pthread"
...
set_target_properties(SDL2::SDL2 PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "m;dl;/usr/lib/libsndio.so;dbus-1;ibus-1.0;gio-2.0;gobject-2.0;glib-2.0;unwind;unwind-generic;ts;-Wl,--no-undefined;-pthread"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libSDL2-2.0.so.0.10.0"
  IMPORTED_SONAME_NOCONFIG "libSDL2-2.0.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS SDL2::SDL2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_SDL2::SDL2 "${_IMPORT_PREFIX}/lib/libSDL2-2.0.so.0.10.0" )
